...
import LiveTvCategoriesView from './LiveTvCategoriesView';
...
const PageTabContent: FC<PageTabContentProps> = ({ parentId, currentTab }) => {
    ...
    if (currentTab.viewType === LibraryTab.Programs) {
        return <LiveTvCategoriesView />;
    }

    if (currentTab.viewType === LibraryTab.Recordings || currentTab.viewType === LibraryTab.Schedule) {
        return (
            <ProgramsSectionView
                sectionType={
